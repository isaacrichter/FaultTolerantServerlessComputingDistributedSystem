        ...
        while (this.myServer.getPeerState() == ZooKeeperPeerServer.ServerState.LEADING) {
            ...
            switch (incoming.getMessage().getMessageType()){
                ...
                case WORK:
                    ...
                    logger.info("Leader serving Request #" + requestIDsCount + " to server #" + serverAtBat);
                    //CHANGES FROM HERE
                    ...
                    RoundRobinLeaderTCPWorker speaker = new RoundRobinLeaderTCPWorker(workOrder, incoming.getSocket(), this.myServer.getServerId());
